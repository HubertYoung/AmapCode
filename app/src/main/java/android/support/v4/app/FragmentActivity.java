...
public class FragmentActivity extends BaseFragmentActivityHoneycomb implements OnRequestPermissionsResultCallback, RequestPermissionsRequestCodeValidator {
    ...
    public final void setSupportMediaController(MediaControllerCompat mediaControllerCompat) {
        ...
        if (VERSION.SDK_INT >= 21) {
            ActivityCompat21.a((Activity) this, mediaControllerCompat.getMediaController());
        }
    }
    ...
    public void onCreate(@Nullable Bundle bundle) {
        ...
        if (nonConfigurationInstances != null) {
            this.mFragments.restoreLoaderNonConfig(nonConfigurationInstances.c);
        }
        if (bundle != null) {
            Parcelable parcelable = bundle.getParcelable(FRAGMENTS_TAG);
            FragmentController fragmentController = this.mFragments;
            if (nonConfigurationInstances != null) {
                list = nonConfigurationInstances.b;
            }
    ...
    public final Object onRetainNonConfigurationInstance() {
        ...
        nonConfigurationInstances.b = retainNonConfig;
        nonConfigurationInstances.c = retainLoaderNonConfig;
    ...
    private static String viewToString(View view) {
        ...
        char c = 'V';
        char c2 = DjangoUtils.EXTENSION_SEPARATOR;
        if (visibility == 0) {
            sb.append('V');
        ...
        char c3 = 'F';
        sb.append(view.isFocusable() ? 'F' : DjangoUtils.EXTENSION_SEPARATOR);
        sb.append(view.isEnabled() ? 'E' : DjangoUtils.EXTENSION_SEPARATOR);
        sb.append(view.willNotDraw() ? DjangoUtils.EXTENSION_SEPARATOR : 'D');
        sb.append(view.isHorizontalScrollBarEnabled() ? 'H' : DjangoUtils.EXTENSION_SEPARATOR);
        if (!view.isVerticalScrollBarEnabled()) {
            c = DjangoUtils.EXTENSION_SEPARATOR;
        }
        sb.append(c);
        sb.append(view.isClickable() ? 'C' : DjangoUtils.EXTENSION_SEPARATOR);
        sb.append(view.isLongClickable() ? 'L' : DjangoUtils.EXTENSION_SEPARATOR);
        sb.append(' ');
        if (!view.isFocused()) {
            c3 = DjangoUtils.EXTENSION_SEPARATOR;
        }
        sb.append(c3);
        sb.append(view.isSelected() ? 'S' : DjangoUtils.EXTENSION_SEPARATOR);
        if (view.isPressed()) {
            c2 = 'P';
        }
        sb.append(c2);
