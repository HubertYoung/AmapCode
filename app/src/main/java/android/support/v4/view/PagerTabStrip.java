...
public class PagerTabStrip extends PagerTitleStrip {
    ...
    public void onDraw(Canvas canvas) {
        ...
        float f2 = f;
        canvas2.drawRect((float) (this.mCurrText.getLeft() - this.mTabPadding), (float) (height - this.mIndicatorHeight), (float) (this.mCurrText.getRight() + this.mTabPadding), f2, this.mTabPaint);
