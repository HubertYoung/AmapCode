            ...
            try {
                ...
                if (staticDataStoreComp != null) {
                    if (dataContext.b != null) {
                        ...
                        str2 = staticDataStoreComp.getAppKeyByIndex(dataContext.a < 0 ? 0 : dataContext.a, StaticConfig.a());
                    }
                    if (str2 != null) {
                        ...
                        if (staticDataEncryptComp != null) {
                            return staticDataEncryptComp.staticSafeEncrypt(16, str2, str, StaticConfig.a());
                        }
                    }
                }
            ...
            try {
                ...
                if (staticDataStoreComp != null) {
                    ...
                    if (str2 != null) {
                        IStaticDataEncryptComponent staticDataEncryptComp = SecurityGuardManager.getInstance(this.a).getStaticDataEncryptComp();
                        if (staticDataEncryptComp != null) {
                            return staticDataEncryptComp.staticSafeDecrypt(16, str2, str, StaticConfig.a());
                        }
                    }
                }
            } catch (SecException unused) {
