...
public class SqliteHelper extends SQLiteOpenHelper {
    ...
    public void onOpen(android.database.sqlite.SQLiteDatabase r3) {
        ...
        L_0x0013:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alibaba.analytics.core.db.SqliteHelper.onOpen(android.database.sqlite.SQLiteDatabase):void");
    }
    ...
    public synchronized SQLiteDatabase getWritableDatabase() {
        try {
            ...
            Logger.w((String) RPCDataItems.SWITCH_TAG_LOG, "e", th);
        }
    ...
    public synchronized void closeWritableDatabase(android.database.sqlite.SQLiteDatabase r5) {
        ...
        L_0x0017:
            com.alibaba.analytics.utils.TaskExecutor r5 = com.alibaba.analytics.utils.TaskExecutor.getInstance()     // Catch:{ Throwable -> 0x002b, all -> 0x0028 }
            r0 = 0
            com.alibaba.analytics.core.db.SqliteHelper$DelayCloseDbTask r1 = r4.mCloseDbTask     // Catch:{ Throwable -> 0x002b, all -> 0x0028 }
