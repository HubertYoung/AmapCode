    ...
    private SQLiteDatabase getDatabaseLocked(boolean writable) {
        ...
        try {
            ...
            if (db != null) {
                ...
                File dbFile = this.mContext.getDatabasePath(this.mName);
            ...
            db = SQLiteDatabase.openDatabase(this.mContext.getDatabasePath(this.mName).getPath(), this.mFactory, 1, this.mErrorHandler, this.mPassword);
        } catch (Throwable th) {
