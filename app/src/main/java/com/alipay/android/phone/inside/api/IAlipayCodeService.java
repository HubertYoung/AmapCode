...
public interface IAlipayCodeService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAlipayCodeService {
        ...
        static class Proxy implements IAlipayCodeService {
        ...
        public static IAlipayCodeService asInterface(IBinder iBinder) {
            ...
            if (queryLocalInterface == null || !(queryLocalInterface instanceof IAlipayCodeService)) {
                return new Proxy(iBinder);
            }
            return (IAlipayCodeService) queryLocalInterface;
        }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i != 1598968902) {
                switch (i) {
                    ...
                    case 2:
                        parcel.enforceInterface(DESCRIPTOR);
                        registerAlipayRemoteCallback(com.alipay.android.phone.inside.api.IAlipayRemoteCallback.Stub.asInterface(parcel.readStrongBinder()));
                        parcel2.writeNoException();
                        return true;
                    default:
