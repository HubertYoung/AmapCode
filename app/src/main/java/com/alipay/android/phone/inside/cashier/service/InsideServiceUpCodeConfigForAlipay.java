...
public class InsideServiceUpCodeConfigForAlipay extends AbstractInsideService<Bundle, Bundle> {
    ...
    public Bundle startForResult(Bundle bundle) throws Exception {
        ...
        return buildResult(getPayHelperService().requestChannel(context, externalInfo));
    }
    ...
    private Bundle buildResult(String str) throws Exception {
        ...
        if (!TextUtils.isEmpty(optString) || !TextUtils.isEmpty(optString2) || !TextUtils.isEmpty(optString3) || !TextUtils.isEmpty(optString2)) {
            ...
            LoggerFactory.f().a((String) "InsideServiceUpCodeConfig::buildResult", (String) "config null");
        }
        return bundle;
    }
