...
public class ClientPackProxy {
    ...
    private static byte[] a(String str, String str2) throws Exception {
        try {
            ...
            PublicKeyManager.b();
            byte[] a2 = Rsa.a(str, PublicKeyManager.a());
    ...
    private static byte[] a(byte[]... r8) throws java.io.IOException {
        ...
        L_0x005d:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alipay.android.phone.inside.log.net.ClientPackProxy.a(byte[][]):byte[]");
    }
    ...
    public final byte[] a(byte[] bArr) throws Exception {
        return a("{\"data\":{\"api_version\":\"1.0\"}}".getBytes("utf-8"), a(this.a, PublicKeyManager.a()), DesCBC.a(this.a, GzipUtils.a(bArr)));
    }
}
