...
public class IotAdxBoothInfoAction implements SdkAction {
    public final String a() {
        return ActionEnum.IOT_ADX_BOOTH_INFO.getActionName();
    }

    public final OperationResult<IotAdxResultCode> a(JSONObject jSONObject) {
        OperationResult<IotAdxResultCode> operationResult = new OperationResult<>(IotAdxResultCode.SUCCESS, ActionEnum.IOT_ADX_BOOTH_INFO.getActionName());
        try {
            Bundle bundle = (Bundle) ServiceExecutor.b("IOT_ADS_PLUGIN_ADX_BOOTH_INFO", jSONObject);
            ...
            operationResult.setCode(IotAdxResultCode.FAILED);
            LoggerFactory.e().a((String) "main", (String) "IotAdxBoothInfoActionEx", th);
        }
