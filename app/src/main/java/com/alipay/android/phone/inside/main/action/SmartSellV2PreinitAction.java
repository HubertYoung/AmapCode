...
public class SmartSellV2PreinitAction implements ISmartSellV2Action {
    private static final String a = "SmartSellV2PreinitAction";

    public final String a() {
        return ActionEnum.SMART_SELL_PAY_AUTH_V2_PREINIT.getActionName();
    }
    ...
    public final OperationResult<PayAuthV2ResultCode> a(JSONObject jSONObject) {
        ...
        OperationResult<PayAuthV2ResultCode> operationResult = new OperationResult<>(PayAuthV2ResultCode.SUCCESS, ActionEnum.SMART_SELL_PAY_AUTH_V2_PREINIT.getActionName());
        String str3 = null;
        try {
            bundle = (Bundle) ServiceExecutor.b("ONCE_AUTH_V2_PLUGIN_PREINIT_SERVICE", jSONObject);
