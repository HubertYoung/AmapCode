...
public class GzipUtils {
    ...
    public static byte[] a(byte[] r6) throws java.io.IOException {
        ...
        L_0x00a4:
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alipay.android.phone.inside.security.util.GzipUtils.a(byte[]):byte[]");
    }
    ...
    public static byte[] b(byte[] r8) throws java.io.IOException {
        ...
        L_0x00ad:
            throw r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.alipay.android.phone.inside.security.util.GzipUtils.b(byte[]):byte[]");
    }
}
