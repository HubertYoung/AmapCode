...
public class H5NumInputKeyboardM40 extends H5NumInputKeyboard implements OnSoftKeyboardListener {
    ...
    private static final String TAG = "H5NumInputKeyboardM40";
    private boolean ifUseRandomNumber;
    private final APWebView mApWebView;
    private Context mContext;
    /* access modifiers changed from: private */
    public H5InputBoardProvider mH5InputBoardProvider;
    private H5InputOperator mH5InputOperator = new H5InputOperator() {
        public void resizeAndHideKeyboard() {
            if (H5NumInputKeyboardM40.this.mH5NativeOnSoftKeyboardListener != null) {
                H5NumInputKeyboardM40.this.mH5NativeOnSoftKeyboardListener.onCustomKeyboardHide();
            }
            H5NumInputKeyboardM40.this.sendBlurToFocusElement();
            H5NumInputKeyboardM40.this.hideCustomKeyboard();
        }
    ...
    public H5NumInputKeyboardM40(Context context, WebView webView, APWebView ap) {
    ...
    public boolean hideCustomKeyboard() {
        ...
        if (this.mKeyboardCallback != null) {
            try {
                ...
                H5Log.d(TAG, "rect ltrb = " + scrRc.left + Token.SEPARATOR + scrRc.top + Token.SEPARATOR + scrRc.right + Token.SEPARATOR + scrRc.bottom);
    ...
    private void showCustomKeyboardCallback() {
        this.mH5InputBoardProvider.getKeyboard().getViewTreeObserver().addOnGlobalLayoutListener(new OnGlobalLayoutListener() {
            public void onGlobalLayout() {
                try {
                    JSONObject params = new JSONObject();
                    Rect scrRc = H5NumInputKeyboardM40.this.getKeyboardScreenRect();
                    params.put("keyboard-screen-rect-left", scrRc.left);
                    params.put("keyboard-screen-rect-top", scrRc.top);
                    params.put("keyboard-screen-rect-right", scrRc.right);
                    params.put("keyboard-screen-rect-bottom", scrRc.bottom);
                    if (H5NumInputKeyboardM40.this.mKeyboardCallback != null) {
                        H5NumInputKeyboardM40.this.mKeyboardCallback.onReceiveValue(params.toString());
                    }
                    H5Log.d(H5NumInputKeyboardM40.TAG, "rect ltrb = " + scrRc.left + Token.SEPARATOR + scrRc.top + Token.SEPARATOR + scrRc.right + Token.SEPARATOR + scrRc.bottom);
                    if (H5NumInputKeyboardM40.this.mH5InputBoardProvider != null && H5NumInputKeyboardM40.this.mH5InputBoardProvider.getKeyboard() != null) {
                        if (VERSION.SDK_INT >= 16) {
                            H5NumInputKeyboardM40.this.mH5InputBoardProvider.getKeyboard().getViewTreeObserver().removeOnGlobalLayoutListener(this);
                        } else {
                            H5NumInputKeyboardM40.this.mH5InputBoardProvider.getKeyboard().getViewTreeObserver().removeGlobalOnLayoutListener(this);
                        }
                    }
                } catch (Exception ex) {
                    H5Log.e(H5NumInputKeyboardM40.TAG, "onReceiveValue exception", ex);
                    if (H5NumInputKeyboardM40.this.mH5InputBoardProvider != null && H5NumInputKeyboardM40.this.mH5InputBoardProvider.getKeyboard() != null) {
                        if (VERSION.SDK_INT >= 16) {
                            H5NumInputKeyboardM40.this.mH5InputBoardProvider.getKeyboard().getViewTreeObserver().removeOnGlobalLayoutListener(this);
                        } else {
