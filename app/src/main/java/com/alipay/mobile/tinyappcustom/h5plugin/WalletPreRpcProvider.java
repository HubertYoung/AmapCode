...
public class WalletPreRpcProvider implements H5PreRpcProvider {
    ...
    private class RpcRequest implements Runnable {
        ...
        public void run() {
            String operationType = H5Utils.getString(this.b, (String) TransportConstants.KEY_OPERATION_TYPE);
            String requestData = H5Utils.getJSONArray(this.b, "requestData", null).toJSONString();
            String gateway = H5Utils.getString(this.b, (String) "gateway");
            String appKey = null;
            if (!TextUtils.isEmpty(gateway)) {
                appKey = c.a(gateway);
            }
            JSONObject headers = H5Utils.getJSONObject(this.b, "headers", null);
            boolean compress = H5Utils.getBoolean(this.b, (String) MultimediaImageProcessor.COMPOSITE_INT_KEY_COMPRESS_LEVEL, true);
            H5Utils.getBoolean(this.b, (String) "retryable", false);
            try {
                String response = c.a(operationType, requestData, gateway, compress, headers, appKey);
                ...
                WalletPreRpcProvider.this.handleResultPool(this.c, joResponse);
            } catch (ExecutionException e) {
                H5Log.e("WalletPreRpcProvider", "exception detail", e);
                WalletPreRpcProvider.this.handleResultPool(this.c, 10);
            } catch (InterruptedException e2) {
                H5Log.e("WalletPreRpcProvider", "exception detail", e2);
                WalletPreRpcProvider.this.handleResultPool(this.c, 11);
            } catch (Exception e3) {
    ...
    public void preRpc() {
        ...
        if (preRpcJo == null) {
            ...
            if (walletLogProvider != null) {
                walletLogProvider.log("H5_PRERPC_SEND", preRpcStr, "appId=" + H5Utils.getString(this.e, (String) "appId") + "^version=" + H5Utils.getString(this.e, (String) "appVersion") + "^publicId=" + H5Utils.getString(this.e, (String) H5Param.PUBLIC_ID) + "^url=" + H5Utils.getString(this.e, (String) "url"), null, null);
            }
        }
    }
