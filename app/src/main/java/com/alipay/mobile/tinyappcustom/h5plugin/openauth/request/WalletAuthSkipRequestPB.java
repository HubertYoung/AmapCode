...
public final class WalletAuthSkipRequestPB extends Message {
    ...
    public WalletAuthSkipRequestPB(WalletAuthSkipRequestPB message) {
        super(message);
        if (message != null) {
    ...
    public WalletAuthSkipRequestPB() {
    }

    public final WalletAuthSkipRequestPB fillTagValue(int tag, Object value) {
        switch (tag) {
            case 1:
    ...
    public final boolean equals(Object other) {
        ...
        if (!(other instanceof WalletAuthSkipRequestPB)) {
            return false;
        }
        WalletAuthSkipRequestPB o = (WalletAuthSkipRequestPB) other;
