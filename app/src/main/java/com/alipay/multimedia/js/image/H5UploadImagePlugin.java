...
public class H5UploadImagePlugin extends MMH5SimplePlugin {
    ...
    public boolean handleEvent(H5Event event, H5BridgeContext context) {
        ...
        Logger.debug("H5UploadImage", "handleEvent params: " + event.getParam() + ", action: " + action);
    ...
    public void downloadImage(H5Event event, H5BridgeContext bridgeContext) {
        ...
        if (TextUtils.isEmpty(multimediaID)) {
            Logger.error((String) "H5UploadImage", (String) "invalid multimediaID");
        ...
        Utils.execute(new Runnable() {
            ...
            public void run() {
                ...
                if (multimediaImageService != null) {
                    ...
                    req.path = H5UploadImagePlugin.this.decodeToPath(multimediaID);
                    req.width = H5UploadImagePlugin.this.dip2px((float) width);
                    req.height = H5UploadImagePlugin.this.dip2px((float) height);
    ...
    public void uploadToMediaService(H5Event event, H5BridgeContext bridgeContext) {
        ...
        final String dataType = H5Utils.getString(event.getParam(), (String) "dataType", (String) H5CompressImagePlugin.DATA_TYPE_DATA_URL);
        final boolean setPublic = H5Utils.getBoolean(event.getParam(), (String) "publicDomain", false);
        Logger.debug("H5UploadImage", "upload data " + data + " business:" + business + " compress:" + compress);
                ...
                if (multimediaImageService != null) {
                    ...
                    req.callback = new APImageUploadCallback() {
                        ...
                        public void onSuccess(APImageUploadRsp apImageUploadRsp) {
                            ...
                            Logger.debug("H5UploadImage", "multimediaID:" + multimediaID + ", url: " + url);
                            if (h5BridgeContext != null) {
                                h5BridgeContext.sendBridgeResult(info);
                            }
                        }
                    ...
                    if (TextUtils.equals(H5CompressImagePlugin.DATA_TYPE_FILE_URL, dataType) || TextUtils.equals(H5CompressImagePlugin.DATA_TYPE_LOCAL_ID, dataType)) {
                        req.path = H5UploadImagePlugin.this.decodeToPath(data);
                    } else if (TextUtils.equals(H5CompressImagePlugin.DATA_TYPE_DATA_URL, dataType)) {
                        try {
