...
public class FFmpegMediaCodecInfo {
    ...
    private static final String TAG = "FFmpegMediaCodecInfo";
    ...
    private static synchronized Map<String, Integer> getKnownCodecList() {
        ...
        synchronized (FFmpegMediaCodecInfo.class) {
            if (sKnownCodecList != null) {
                map = sKnownCodecList;
            } else {
                TreeMap treeMap = new TreeMap(String.CASE_INSENSITIVE_ORDER);
                sKnownCodecList = treeMap;
                treeMap.put("OMX.Nvidia.h264.decode", Integer.valueOf(0));
                sKnownCodecList.put("OMX.Nvidia.h264.decode.secure", Integer.valueOf(0));
                sKnownCodecList.put("OMX.Intel.hw_vd.h264", Integer.valueOf(0));
                sKnownCodecList.put("OMX.Intel.VideoDecoder.AVC", Integer.valueOf(0));
                ...
                sKnownCodecList.put("OMX.SEC.AVC.Decoder", Integer.valueOf(0));
                sKnownCodecList.put("OMX.SEC.avcdec", Integer.valueOf(0));
                sKnownCodecList.put("OMX.SEC.avc.sw.dec", Integer.valueOf(200));
                sKnownCodecList.put("OMX.Exynos.avc.dec", Integer.valueOf(800));
                sKnownCodecList.put("OMX.Exynos.AVC.Decoder", Integer.valueOf(SecExceptionCode.SEC_ERROR_STA_KEY_ENC_UNKNOWN_ERROR));
                sKnownCodecList.put("OMX.k3.video.decoder.avc", Integer.valueOf(0));
                sKnownCodecList.put("OMX.IMG.MSVDX.Decoder.AVC", Integer.valueOf(800));
                sKnownCodecList.put("OMX.TI.DUCATI1.VIDEO.DECODER", Integer.valueOf(0));
                sKnownCodecList.put("OMX.rk.video_decoder.avc", Integer.valueOf(0));
                sKnownCodecList.put("OMX.amlogic.avc.decoder.awesome", Integer.valueOf(0));
                sKnownCodecList.put("OMX.MARVELL.VIDEO.HW.CODA7542DECODER", Integer.valueOf(0));
    ...
    @TargetApi(16)
    public static FFmpegMediaCodecInfo setupCandidate(MediaCodecInfo codecInfo, String mimeType) {
        int rank;
        ...
        FFmpegMediaCodecInfo candidate = new FFmpegMediaCodecInfo();
    ...
    public static String getLevelName(int level) {
        switch (level) {
            ...
            case 2048:
                return "4";
            case 4096:
                return SuperId.BIT_2_INDOOR_TAG_HOT;
            case 8192:
                return "42";
            case 16384:
                return "5";
