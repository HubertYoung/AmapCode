...
public final class k extends Table {
    public static int a(FlatBufferBuilder flatBufferBuilder, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, int i9) {
    ...
    public static int a(FlatBufferBuilder flatBufferBuilder, int i, int i2, int i3, int i4) {
        flatBufferBuilder.startObject(9);
        e(flatBufferBuilder, i3);
        d(flatBufferBuilder, i2);
        c(flatBufferBuilder, i);
        i(flatBufferBuilder, i4);
        return a(flatBufferBuilder);
    }
