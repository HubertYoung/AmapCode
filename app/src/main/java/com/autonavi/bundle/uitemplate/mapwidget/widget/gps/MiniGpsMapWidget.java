...
public class MiniGpsMapWidget extends AbstractMapWidget<MiniGpsWidgetPresenter> {
    public MiniGpsMapWidget(Context context, IWidgetProperty iWidgetProperty) {
