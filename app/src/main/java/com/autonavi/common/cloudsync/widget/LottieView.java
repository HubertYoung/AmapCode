...
public class LottieView extends LinearLayout {
    ...
    private static final String GROUP_NAME_COMMONUI = "basemap.commonui";
    ...
    private final float PLAY_BACK_SPEED = 1.0f;
    ...
    public void startPlay(boolean z) {
        ...
        if (currentPageConfig == null) {
            AMapLog.debug(GROUP_NAME_COMMONUI, "LottieView", "lottieConfig is null");
            return;
        }
