...
public class VehiclesDao extends AbstractDao<Vehicles, Long> {
    ...
    public static class Properties {
        ...
        static {
            ...
            w = property23;
            Property property24 = new Property(23, String.class, "vehicle_restrictionMsg", false, "VEHICLE_RESTRICTIONMSG");
            x = property24;
            Property property25 = new Property(24, Integer.class, "vehicle_limitDateType", false, "VEHICLE_LIMITDATETYPE");
            y = property25;
        }
    }
    ...
    public /* synthetic */ void bindValues(SQLiteStatement sQLiteStatement, Object obj) {
        ...
        String str17 = vehicles.vehicle_restrictionMsg;
        if (str17 != null) {
            sQLiteStatement.bindString(24, str17);
        }
        Integer num6 = vehicles.vehicle_limitDateType;
        if (num6 != null) {
            sQLiteStatement.bindLong(25, (long) num6.intValue());
        }
    }
    ...
    public /* synthetic */ void readEntity(Cursor cursor, Object obj, int i) {
        ...
        int i25 = i + 23;
        vehicles.vehicle_restrictionMsg = cursor.isNull(i25) ? null : cursor.getString(i25);
        int i26 = i + 24;
        if (!cursor.isNull(i26)) {
            num = Integer.valueOf(cursor.getInt(i26));
        }
        vehicles.vehicle_limitDateType = num;
    }
    ...
    public VehiclesDao(DaoConfig daoConfig, xt xtVar) {
    ...
    public static void a(SQLiteDatabase sQLiteDatabase) {
        ...
        sb.append("\"VEHICLES\" (\"_id\" INTEGER PRIMARY KEY AUTOINCREMENT ,\"VEHICLE_ID\" INTEGER,\"UID\" TEXT,\"VEHICLE_PLATE_NUM\" TEXT,\"VEHICLE_VEHICLECODE\" TEXT,\"VEHICLE_BRAND_NAME\" TEXT,\"VEHICLE_VEHICLE_STYLE\" TEXT,\"VEHICLE_DISCHARGE_RATE\" TEXT,\"VEHICLE_YEARS\" TEXT,\"VEHICLE_REMARK\" TEXT,\"VEHICLE_VEHICLE_MSG\" TEXT,\"VEHICLE_TELEPHONE\" TEXT,\"VEHICLE_VEHICLE_LOGO\" TEXT,\"VEHICLE_OFTEN_USE\" INTEGER,\"VEHICLE_FRAME_NUM\" TEXT,\"VEHICLE_ENGINE_NUM\" TEXT,\"VEHICLE_VIOLATION_URL\" TEXT,\"VEHICLE_VIOLATION_NUM\" INTEGER,\"VEHICLE_VALIDITY_PERIOD\" TEXT,\"VEHICLE_MODIFICATION_TIMES\" TEXT,\"VEHICLE_CHECK_REMINDER\" INTEGER,\"VEHICLE_VIOLATION_REMINDER\" INTEGER,\"VEHICLE_LIMIT_REMINDER\" INTEGER,\"VEHICLE_RESTRICTIONMSG\" TEXT,\"VEHICLE_LIMITDATETYPE\" INTEGER);");
    ...
    public /* synthetic */ Object readEntity(Cursor cursor, int i) {
        ...
        if (!cursor.isNull(i25)) {
            vehicles.vehicle_restrictionMsg = cursor.getString(i25);
        }
        int i26 = i + 24;
        if (!cursor.isNull(i26)) {
            vehicles.vehicle_limitDateType = Integer.valueOf(cursor.getInt(i26));
        }
        return vehicles;
    }
}
