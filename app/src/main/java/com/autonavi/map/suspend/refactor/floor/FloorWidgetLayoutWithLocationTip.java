...
public class FloorWidgetLayoutWithLocationTip extends RelativeLayout {
    ...
    public void setFloorView(FloorWidgetView floorWidgetView, a aVar) {
        if (this.mFloorView != floorWidgetView) {
            if (this.mFloorView != null) {
                this.mFloorView.setContainer(null);
            }
            this.mFloorView = floorWidgetView;
            this.mFloorView.setContainer(aVar);
    ...
    public void onMeasure(int i, int i2) {
        ...
        setMeasuredDimension(resolveSize(this.mNormalLocatioNDrawable.getIntrinsicWidth() + this.mBetweenMargin + this.mFloorView.getMeasuredWidth(), i), resolveSize(this.mFloorView.getMeasuredHeight(), i2));
    }
