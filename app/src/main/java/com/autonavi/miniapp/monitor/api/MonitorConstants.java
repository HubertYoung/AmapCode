...
public class MonitorConstants {
    ...
    public static final String ACTION_TIME_TO_COUNT_STEP = ".monitor.action.TIME_TO_COUNT_STEP";
    ...
    public static final String BACKGROUND_DELAY_EVENT = ".monitor.action.BACKGROUND_DELAY_EVENT";
    ...
    public static final String SP_FILENAME_MONITOR_TRAFFIC = "monitorTraffic";
