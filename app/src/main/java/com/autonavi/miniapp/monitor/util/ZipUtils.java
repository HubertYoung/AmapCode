...
public class ZipUtils {
    ...
    public static void zipFile(java.util.List<java.io.File> r9, java.lang.String r10, java.io.File r11, com.autonavi.miniapp.monitor.util.ZipUtils.ZipFileHandler r12) throws java.lang.Exception {
        /*
        ...
        L_0x00ef:
            ...
            throw r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.autonavi.miniapp.monitor.util.ZipUtils.zipFile(java.util.List, java.lang.String, java.io.File, com.autonavi.miniapp.monitor.util.ZipUtils$ZipFileHandler):void");
    }
    ...
    /* Code decompiled incorrectly, please refer to instructions dump. */
    private static java.lang.String getAbsFileName(java.io.File r2, java.io.File r3, com.autonavi.miniapp.monitor.util.ZipUtils.ZipFileHandler r4) {
        /*
            r0 = 0
        ...
        L_0x0047:
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.autonavi.miniapp.monitor.util.ZipUtils.getAbsFileName(java.io.File, java.io.File, com.autonavi.miniapp.monitor.util.ZipUtils$ZipFileHandler):java.lang.String");
    }
    ...
    public static byte[] gzipDataByBytes(byte[] r3, int r4, int r5) throws java.lang.IllegalStateException {
        ...
        L_0x0035:
            throw r3
        */
        throw new UnsupportedOperationException("Method not decompiled: com.autonavi.miniapp.monitor.util.ZipUtils.gzipDataByBytes(byte[], int, int):byte[]");
    }
    ...
    public static byte[] ungzipDataToBytes(byte[] r4, int r5, int r6) throws java.lang.IllegalStateException {
        ...
        L_0x004a:
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.autonavi.miniapp.monitor.util.ZipUtils.ungzipDataToBytes(byte[], int, int):byte[]");
    }
}
