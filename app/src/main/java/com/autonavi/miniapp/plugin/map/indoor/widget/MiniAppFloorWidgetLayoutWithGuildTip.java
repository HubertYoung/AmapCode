...
public class MiniAppFloorWidgetLayoutWithGuildTip extends LinearLayout implements IContainer {
    ...
    public MiniAppFloorWidgetLayoutWithGuildTip(Context context) {
        super(context);
        init(context);
    }

    public MiniAppFloorWidgetLayoutWithGuildTip(Context context, AttributeSet attributeSet) {
    ...
    public void init(Context context) {
        LayoutInflater.from(context).inflate(R.layout.miniapp_floor_widget_with_guild_tip, this);
        initView();
    }

    /* access modifiers changed from: 0000 */
    public void initView() {
        this.floorWidgetViewLayout = (MiniAppFloorWidgetLayoutWithLocationTip) findViewById(R.id.floor_widget_view_layout);
