...
class MarkerStyle2 extends BaseMarkerStyle {
    ...
    public MarkerStyle2(H5Page h5Page, Context context) {
        ...
        this.mTopBottomPadding = DensityUtil.dip2px(context, 9.0f);
        ...
        this.mTextPaint.setColor(-570425344);
        ...
        if (!TextUtils.isEmpty(this.mIcon1)) {
            H5MapUtils.getImgFromPkg((H5Page) this.mPage.get(), this.mIcon1, new ImgCallback() {
                public void onLoadImage(Bitmap bitmap) {
                    MarkerStyle2.this.mLaunch = MarkerStyle2.this.mLaunch + 1;
                    if (bitmap != null) {
    ...
    public void drawIcon2(Canvas canvas, Bitmap bitmap) {
        ...
        paint.setAntiAlias(true);
        canvas.save();
        canvas.translate(0.0f, (float) ((((this.mMeasuredHeight - this.mBubbleTailSize) - this.mBubbleTailCircleRedis) - this.mIcon2Size) / 2));
        canvas.drawBitmap(bitmap, getMatrix(new Rect(0, 0, bitmap.getWidth(), bitmap.getHeight()), new Rect(0, 0, this.mIcon1Size, this.mIcon1Size)), paint);
        canvas.restore();
    }
    ...
    private void drawText(Canvas canvas) {
        ...
        canvas.drawText(this.mText1, (float) (this.mLeftRightMargin + this.mLeftRightPadding + this.mIcon1Size + this.mTextLeftMargin), (float) ((int) ((((float) (((this.mMeasuredHeight - this.mBubbleTailSize) - this.mBubbleTailCircleRedis) / 2)) - (fontMetrics.top / 2.0f)) - (fontMetrics.bottom / 2.0f))), this.mTextPaint);
    }
    ...
    private void drawBubble(Canvas canvas) {
        ...
        canvas.drawCircle((float) (this.mBubbleWidth / 2), (float) ((this.mMeasuredHeight - this.mBubbleTailCircleRedis) - 1), (float) this.mBubbleTailCircleRedis, paint);
        paint.setColor(-228864);
        canvas.drawCircle((float) (this.mBubbleWidth / 2), (float) ((this.mMeasuredHeight - this.mBubbleTailCircleRedis) - 1), (float) (this.mBubbleTailCircleRedis - 3), paint);
        paint.setColor(-263173);
        rectF.set(0.0f, 0.0f, (float) this.mBubbleWidth, (float) ((this.mMeasuredHeight - this.mBubbleTailSize) - this.mBubbleTailCircleRedis));
        canvas.drawRoundRect(rectF, rectF.height() / 2.0f, rectF.height() / 2.0f, paint);
        int i = this.mBubbleWidth / 2;
        int sqrt = (this.mMeasuredHeight - this.mBubbleTailCircleRedis) - ((int) (((double) this.mBubbleTailSize) * Math.sqrt(2.0d)));
        ...
        paint.setColor(-6400);
        rectF.set(3.0f, 3.0f, (float) (this.mBubbleWidth - 3), (float) (((this.mMeasuredHeight - this.mBubbleTailSize) - this.mBubbleTailCircleRedis) - 3));
        canvas.drawRoundRect(rectF, rectF.height() / 2.0f, rectF.height() / 2.0f, paint);
        int i2 = this.mBubbleWidth / 2;
        int sqrt2 = (this.mMeasuredHeight - this.mBubbleTailCircleRedis) - ((int) (((double) this.mBubbleTailSize) * Math.sqrt(2.0d)));
        rectF.set((float) ((i2 - this.mBubbleTailSize) + 3), (float) ((sqrt2 - this.mBubbleTailSize) + 3), (float) ((i2 + this.mBubbleTailSize) - 3), (float) ((sqrt2 + this.mBubbleTailSize) - 3));
