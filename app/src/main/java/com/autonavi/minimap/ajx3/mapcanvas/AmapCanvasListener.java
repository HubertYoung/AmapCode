...
public class AmapCanvasListener implements amk {
    private BeforeDrawFrameListener mBeforeDrawFrameListener;
    ...
    public AmapCanvasListener(BeforeDrawFrameListener beforeDrawFrameListener) {
        this.mBeforeDrawFrameListener = beforeDrawFrameListener;
    }

    public void beforeDrawFrame(int i, GLMapState gLMapState) {
        this.mBeforeDrawFrameListener.beforeDrawFrame(i, gLMapState);
    }
}
