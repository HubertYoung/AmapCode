...
public class UpdatableWebRequest extends AosPostRequest {
    ...
    static {
        ...
        sb.append("ws/shield/dyui/ajx3/updatable/v3/web");
        URL = sb.toString();
    }

    public UpdatableWebRequest() {
        this.package_info = null;
    }

    public UpdatableWebRequest(String str) {
