...
public class Ajx3OfflineLabel extends OfflineLabel implements ViewExtension, IStrictModeView {
    protected BaseProperty mProperty;
    private long mTemplatePtr;

    public Ajx3OfflineLabel(@NonNull IAjxContext iAjxContext) {
        super(iAjxContext.getNativeContext());
        this.mProperty = new Ajx3OfflineLabelProperty(this, iAjxContext);
    }
