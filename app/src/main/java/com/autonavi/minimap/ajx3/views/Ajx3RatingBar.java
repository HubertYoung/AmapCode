...
public class Ajx3RatingBar extends NewRatingBar implements ViewExtension {
    private BaseProperty mProperty;

    public Ajx3RatingBar(@NonNull IAjxContext iAjxContext) {
        super(iAjxContext.getNativeContext());
        this.mProperty = new Ajx3RatingBarProperty(this, iAjxContext);
    }
