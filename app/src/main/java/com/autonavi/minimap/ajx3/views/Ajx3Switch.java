...
import com.amap.bundle.commonui.switchbutton.AmapSwitch;
...
public class Ajx3Switch extends AmapSwitch implements ViewExtension {
    protected BaseProperty mProperty;

    public Ajx3Switch(@NonNull IAjxContext iAjxContext) {
        super(iAjxContext.getNativeContext());
        this.mProperty = new Ajx3SwitchProperty(this, iAjxContext);
    }
