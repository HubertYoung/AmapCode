...
public class OrderHotelListPresenter$1 extends LifeNetRequestCallback<dqc> {
    final /* synthetic */ int a;
    final /* synthetic */ Dialog b;
    final /* synthetic */ dqg c;

    /* JADX WARN: Illegal instructions before constructor call commented (this can break semantics) */
    public OrderHotelListPresenter$1(dqg dqg, Callback callback, int i, Dialog dialog) {
        // this.c = dqg;
        // this.a = i;
        // this.b = dialog;
        super(callback);
