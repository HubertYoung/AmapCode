...
public class ShareRidingNaviOverlay extends AbstractNaviOverlay {
    public ShareRidingNaviOverlay(bty bty) {
        super(bty);
        resumeMarker();
    }
    ...
    public void drawNaviLineV3(GeoPoint geoPoint, int i, int i2) {
        this.mMapView.a((GLNaviOverlay) this.mGLOverlay, null, geoPoint, 0, i, -1, i2, geoPoint);
    }

    public void drawNaviLineV2(GeoPoint geoPoint, int i) {
