...
public final class ExtTrainUIStatusController {
    View a;
    ...
    private ExtTrainPlanListPage g;
    private View h;
    private View i;
    private ImageView j;
    private TextView k;
        ...
        if (requestStatus == RequestStatus.LOADING) {
            ...
            aho.a(new Runnable() {
                public final void run() {
                    ...
                    ExtTrainUIStatusController.this.a.setClickable(true);
                }
            }, 200);
