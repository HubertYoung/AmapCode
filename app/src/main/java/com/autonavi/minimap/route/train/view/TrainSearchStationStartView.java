...
public class TrainSearchStationStartView extends RelativeLayout implements OnClickListener {
    ...
    private void addViews() {
        this.mSearchLayout = (RelativeLayout) LayoutInflater.from(this.mContext).inflate(R.layout.train_search_station_start_input_view, null);
        ...
        this.mEditSearch.addTextChangedListener(new TextWatcher() {
            ...
            public final void afterTextChanged(Editable editable) {
                if (editable.length() > 0) {
                    TrainSearchStationStartView.this.mBtnSubmit.setVisibility(8);
                    TrainSearchStationStartView.this.mBtnSearchClear.setVisibility(0);
                    return;
                }
                if (editable.length() == 0) {
                    TrainSearchStationStartView.this.mBtnSubmit.setVisibility(0);
                    TrainSearchStationStartView.this.mBtnSearchClear.setVisibility(8);
                }
            }
        });
