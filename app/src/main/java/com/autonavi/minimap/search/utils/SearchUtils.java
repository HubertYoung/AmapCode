...
public class SearchUtils {
    ...
    public static int processTipItemIcon(com.autonavi.bundle.entity.sugg.TipItem r2) {
        ...
        L_0x003a:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.autonavi.minimap.search.utils.SearchUtils.processTipItemIcon(com.autonavi.bundle.entity.sugg.TipItem):int");
    }
