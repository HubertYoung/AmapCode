...
public class TitleBar extends ViewGroup implements OnClickListener {
    ...
    private void init(int i) {
        ...
        if (euk.a()) {
            this.mStausBarHeight = euk.a(getContext());
        }
    }
    ...
    private int getBackgroundId(int r3) {
        ...
        L_0x001b:
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.autonavi.widget.ui.TitleBar.getBackgroundId(int):int");
    }
    ...
    public void onLayout(boolean z, int i, int i2, int i3, int i4) {
        int i5;
        int i6;
        this.mLeftLayout.layout(0, this.mStausBarHeight, this.mLeftLayout.getMeasuredWidth(), this.mLeftLayout.getMeasuredHeight() + this.mStausBarHeight);
        if (this.mRightLayout == null || this.mRightLayout.getMeasuredWidth() == 0) {
            i5 = 0;
        } else {
            i5 = this.mRightLayout.getMeasuredWidth();
            this.mRightLayout.layout(this.mTitleWidth - i5, this.mStausBarHeight, this.mTitleWidth, this.mRightLayout.getMeasuredHeight() + this.mStausBarHeight);
        }
        if (!isCentered()) {
        ...
        this.mCenterLayout.layout(i5, this.mStausBarHeight, i6, getMeasuredHeight());
    ...
    public void onMeasure(int i, int i2) {
        ...
        if (this.mRightLayout != null) {
            ...
            i4 = this.mRightLayout.getMeasuredWidth();
        }
        if (!isCentered()) {
            i3 = (this.mTitleWidth - measuredWidth) - i4;
        } else if (measuredWidth > i4) {
            i3 = this.mTitleWidth - (measuredWidth * 2);
        } else {
            i3 = this.mTitleWidth - (i4 * 2);
        }
        this.mCenterLayout.measure(MeasureSpec.makeMeasureSpec(i3, UCCore.VERIFY_POLICY_QUICK), makeMeasureSpec);
        if (this.mDividerView != null) {
            measureChild(this.mDividerView, makeMeasureSpec2, makeMeasureSpec);
        }
        setMeasuredDimension(MeasureSpec.getSize(makeMeasureSpec2), this.mHeight + this.mStausBarHeight);
    }
