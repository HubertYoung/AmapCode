...
public class SymbolInfo {
    ...
    static {
        ...
        SymbolInfo symbolInfo26 = new SymbolInfo(false, 696, LZMA_Base.kNumLenSymbols, 22, 22, 16, 174, 68);
        ...
        SymbolInfo symbolInfo29 = new SymbolInfo(false, 1304, 496, 20, 20, 36, EndBill.END_ORDER_FAILED, 62);
    ...
    public final String toString() {
        StringBuilder sb = new StringBuilder(String.valueOf(this.rectangular ? "Rectangular Symbol:" : "Square Symbol:"));
