...
public final class Code93Reader extends OneDReader {
    ...
    static {
        int[] iArr = {276, 328, 324, 322, 296, 292, 290, 336, 274, 266, 424, FlowControl.STATUS_FLOW_CTRL_ALL, Util.TOF_TAG, 404, 402, 394, 360, 356, 354, SecExceptionCode.SEC_ERROR_STA_NO_MEMORY, 282, 344, 332, 326, 300, 278, 436, 434, 428, 422, 406, H5ErrorCode.HTTP_GONE, 364, 358, SecExceptionCode.SEC_ERROR_STA_INVALID_ENCRYPTED_DATA, 314, 302, 468, 466, 458, 366, 374, 430, 294, 474, 470, SecExceptionCode.SEC_ERROR_STA_KEY_NOT_EXISTED, BaseClickableSpan.CLICK_ENABLE_TIME};
