...
final class EANManufacturerOrgSupport {
    ...
    private synchronized void initIfNeeded() {
        if (this.ranges.isEmpty()) {
            ...
            add(new int[]{60, DumpSegment.ANDROID_ROOT_DEBUGGER}, "US/CA");
            ...
            add(new int[]{500, MessageCode.MSG_BUILDING_NOT_SUPPORTED}, "GB");
            add(new int[]{520}, "GR");
            ...
            add(new int[]{535}, "MT");
            add(new int[]{539}, "IE");
            add(new int[]{VideoRecordParameters.HD_HEIGHT_16_9, 549}, "BE/LU");
            add(new int[]{560}, "PT");
            add(new int[]{569}, "IS");
            ...
            add(new int[]{893}, "VN");
            add(new int[]{896}, "PK");
            add(new int[]{899}, AutoJsonUtils.JSON_ID);
