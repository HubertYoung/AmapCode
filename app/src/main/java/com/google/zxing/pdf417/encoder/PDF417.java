...
public final class PDF417 {
    ...
    public final void generateBarcodeLogic(String str, int i) throws WriterException {
    ...
    private int[] determineDimensions(int i, int i2) throws WriterException {
        ...
        throw new WriterException((String) "Unable to fit message in columns");
    }
    ...
    public final void setCompaction(Compaction compaction2) {
