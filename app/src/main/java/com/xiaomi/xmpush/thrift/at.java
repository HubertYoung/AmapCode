...
public class at implements Serializable, Cloneable, org.apache.thrift.a<at, a> {
    ...
    static {
        ...
        enumMap.put(a.REQUEST, new b("request", 2, new g(ClientRpcPack.SYMMETRIC_ENCRYPT_3DES, as.class)));
    ...
    public void a(org.apache.thrift.protocol.e r5) {
        ...
        L_0x0054:
            byte r1 = r0.b
            if (r1 != r2) goto L_0x0011
            com.xiaomi.xmpush.thrift.as r0 = new com.xiaomi.xmpush.thrift.as
            r0.<init>()
            r4.e = r0
            com.xiaomi.xmpush.thrift.as r0 = r4.e
            r0.a(r5)
            goto L_0x0000
        L_0x0065:
            byte r1 = r0.b
    ...
    public boolean a(at atVar) {
        ...
        boolean a2 = a();
        boolean a3 = atVar.a();
        if ((a2 || a3) && (!a2 || !a3 || !this.a.equals(atVar.a))) {
            return false;
        }
        boolean b2 = b();
        boolean b3 = atVar.b();
        if ((b2 || b3) && (!b2 || !b3 || !this.b.a(atVar.b))) {
            return false;
        }
        boolean c2 = c();
        boolean c3 = atVar.c();
        if ((c2 || c3) && (!c2 || !c3 || !this.c.equals(atVar.c))) {
            return false;
        }
        boolean d2 = d();
        boolean d3 = atVar.d();
        if ((d2 || d3) && (!d2 || !d3 || !this.d.equals(atVar.d))) {
            return false;
        }
        boolean e2 = e();
        boolean e3 = atVar.e();
        if ((e2 || e3) && (!e2 || !e3 || !this.e.a(atVar.e))) {
            return false;
        }
        boolean f2 = f();
        boolean f3 = atVar.f();
        if ((f2 || f3) && (!f2 || !f3 || this.f != atVar.f)) {
            return false;
        }
        boolean g2 = g();
        boolean g3 = atVar.g();
        if ((g2 || g3) && (!g2 || !g3 || !this.g.equals(atVar.g))) {
            return false;
        }
        boolean i2 = i();
        boolean i3 = atVar.i();
        if ((i2 || i3) && (!i2 || !i3 || !this.h.equals(atVar.h))) {
            return false;
        }
        boolean j2 = j();
        boolean j3 = atVar.j();
        if ((j2 || j3) && (!j2 || !j3 || !this.i.equals(atVar.i))) {
            return false;
        }
        boolean l2 = l();
        boolean l3 = atVar.l();
        return (!l2 && !l3) || (l2 && l3 && this.j.equals(atVar.j));
    }
    ...
    public int compareTo(at atVar) {
        ...
        if (a()) {
            int a2 = org.apache.thrift.b.a(this.a, atVar.a);
            if (a2 != 0) {
                return a2;
            }
        }
        ...
        if (b()) {
            int a3 = org.apache.thrift.b.a((Comparable) this.b, (Comparable) atVar.b);
            if (a3 != 0) {
                return a3;
            }
        }
        ...
        if (c()) {
            int a4 = org.apache.thrift.b.a(this.c, atVar.c);
            if (a4 != 0) {
                return a4;
            }
        }
        ...
        if (d()) {
            int a5 = org.apache.thrift.b.a(this.d, atVar.d);
            if (a5 != 0) {
                return a5;
            }
        }
        ...
        if (e()) {
            int a6 = org.apache.thrift.b.a((Comparable) this.e, (Comparable) atVar.e);
            if (a6 != 0) {
                return a6;
            }
        }
        ...
        if (f()) {
            int a7 = org.apache.thrift.b.a(this.f, atVar.f);
            if (a7 != 0) {
                return a7;
            }
        }
        ...
        if (g()) {
            int a8 = org.apache.thrift.b.a(this.g, atVar.g);
            if (a8 != 0) {
                return a8;
            }
        }
        ...
        if (i()) {
            int a9 = org.apache.thrift.b.a(this.h, atVar.h);
            if (a9 != 0) {
                return a9;
            }
        }
        ...
        if (j()) {
            int a10 = org.apache.thrift.b.a(this.i, atVar.i);
            if (a10 != 0) {
                return a10;
            }
        }
        ...
        if (l()) {
            int a11 = org.apache.thrift.b.a(this.j, atVar.j);
            if (a11 != 0) {
                return a11;
            }
        }
