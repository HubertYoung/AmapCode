...
public final class aba {
    ...
    public static List<abg> a(String str) {
        if (str == null) {
            return Collections.emptyList();
        }
        abb abb = abb.a;
        abc abc = new abc(str.length());
        abc.a(str);
        abh abh = new abh(abc.b);
        ArrayList arrayList = new ArrayList();
        while (true) {
            if (abh.b >= abh.a) {
                return arrayList;
            }
            abg a2 = abb.a(abc, abh, a);
            if (a2.a.length() > 0) {
                arrayList.add(new abg(a2.a, Uri.decode(a2.b)));
            }
        }
    }

    public static String a(List<? extends abg> list, String str) {
        StringBuilder sb = new StringBuilder();
        for (abg abg : list) {
            String a2 = a(abg.a, str);
            String a3 = a(abg.b, str);
            if (sb.length() > 0) {
                sb.append("&");
            }
            sb.append(a2);
    ...
    public static String a(Iterable<? extends abg> iterable, Charset charset) {
        StringBuilder sb = new StringBuilder();
        for (abg abg : iterable) {
            String d2 = d(abg.a, charset);
            String d3 = d(abg.b, charset);
            if (sb.length() > 0) {
                sb.append("&");
            }
            sb.append(d2);
