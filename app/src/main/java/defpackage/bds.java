...
/* compiled from: SlidableViewDragHelper */
public final class bds {
    ...
    private bds(Context context, ViewGroup viewGroup, Interpolator interpolator, a aVar) {
        if (viewGroup == null) {
    ...
    public static bds a(ViewGroup viewGroup, Interpolator interpolator, a aVar) {
        bds bds = new bds(viewGroup.getContext(), viewGroup, interpolator, aVar);
        bds.b = (int) (((float) bds.b) * 0.2f);
        return bds;
    }
}
