...
import com.amap.bundle.drive.common.dialog.nightmode.widget.NightModeRelativeLayout;
import com.autonavi.minimap.R;

/* renamed from: nf reason: default package */
/* compiled from: NightModeRelativeLayoutAttrsWrapper */
public final class nf extends my<NightModeRelativeLayout> {
    public nf(Context context, AttributeSet attributeSet, int i, NightModeRelativeLayout nightModeRelativeLayout) {
