...
public class InternalGifImageView extends ImageView {
    private boolean mFreezesAnimation;

    public InternalGifImageView(Context context) {
        super(context);
    }

    public InternalGifImageView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        postInit(fhl.a((ImageView) this, attributeSet, 0, 0));
    }

    public InternalGifImageView(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        postInit(fhl.a((ImageView) this, attributeSet, i, 0));
    }

    @RequiresApi(21)
    public InternalGifImageView(Context context, AttributeSet attributeSet, int i, int i2) {
