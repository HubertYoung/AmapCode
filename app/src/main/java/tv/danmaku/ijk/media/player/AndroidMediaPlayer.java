...
public class AndroidMediaPlayer extends AbstractMediaPlayer {
    ...
    class AndroidMediaPlayerListenerHolder implements OnBufferingUpdateListener, OnCompletionListener, OnErrorListener, OnInfoListener, OnPreparedListener, OnSeekCompleteListener, OnVideoSizeChangedListener {
